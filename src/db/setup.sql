...
INSERT INTO authors (name, email, bio) VALUES
  ('Mateo Giussano', 'mgiussano@example.com', 'Desarrollador full-stack apasionada por Node.js'),
  ('Pedro Giussano', 'pgiussano@example.com', 'Escritor técnico especializado en bases de datos'),
  ('María Eugenia Mellano', 'memellano@example.com', 'Ingeniera de software con foco en APIs REST');
